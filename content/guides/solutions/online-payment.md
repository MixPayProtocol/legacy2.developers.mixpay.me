...
3.  Users scan the QR code to pay and the Online Payment look query the payment results.
...
1.  You can use this [api](https://developers.mixpay.me/docs/api/payments/pay) to integrate with MixPay. The specific parameters are like below. And you can place the payment link on a button, and the customers scan the QR code to pay.
...
When you've generated the payment link, you can place the payment link on a button in your website. Maybe you can use `<button>` html tag, or create responsive buttons using JavaScript.
