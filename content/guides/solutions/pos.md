...
1.  You can use this [api](https://developers.mixpay.me/api/payments/pay) to integrate with MixPay. The specific parameters are like below. And you can convert this url to QR code, and the customers scan the QR code to pay.
